...
# Create masari user
RUN adduser --system --group --disabled-password masari && \
	mkdir -p /wallet /home/masari/.masari && \
	chown -R masari:masari /home/masari/.masari && \
	chown -R masari:masari /wallet

# Contains the blockchain
VOLUME /home/masari/.masari
